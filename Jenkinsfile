pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: '59c2bf3c-4cb0-498c-81b7-466adf362775', url: 'https://github.com/akannan1087/myJan2021Repo']]])
            }
        }
